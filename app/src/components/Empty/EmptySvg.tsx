const EmptySvg = () => (
  <svg width="130" height="80" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <linearGradient x1="44.79%" y1="100%" x2="44.79%" y2="0%" id="prefix__b">
        <stop stopColor="#FFF" stopOpacity="0" offset="0%" />
        <stop stopColor="#96A1C5" stopOpacity=".373" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="100%" x2="50%" y2="-19.675%" id="prefix__c">
        <stop stopColor="#FFF" stopOpacity="0" offset="0%" />
        <stop stopColor="#919191" stopOpacity=".15" offset="100%" />
      </linearGradient>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="44.95%" id="prefix__d">
