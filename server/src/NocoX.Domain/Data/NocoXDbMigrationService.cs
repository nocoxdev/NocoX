...
public class NocoXDbMigrationService : ITransientDependency
{
    public ILogger<NocoXDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly INocoXDbSchemaMigrator _dbSchemaMigrator;

    public NocoXDbMigrationService(IDataSeeder dataSeeder, INocoXDbSchemaMigrator dbSchemaMigrator)
    {
        _dataSeeder = dataSeeder;
        _dbSchemaMigrator = dbSchemaMigrator;

        Logger = NullLogger<NocoXDbMigrationService>.Instance;
    }
